...
In addition to the busses, the 68HC05 also communicates with the outside world through its SCI (Serial Communications Interface). This interface utilizes three different special purpose pins of port D. The SCI is an onboard UART which sends and receives MIDI information supplied by the MIDI interface.
